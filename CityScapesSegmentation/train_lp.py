...
# network.resnet = Upgrade(network.resnet, "LPA").new_net.cuda()
network = Upgrade(network, "LPA").new_net.cuda()




train_dataset = DatasetTrain(cityscapes_data_path="",
...
with open("/CityScapes/leftImg8bit/meta/class_weights.pkl", "rb") as file: # (needed for python3)
