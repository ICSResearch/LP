...
os.environ.setdefault("CITYSCAPES_RESULTS", "/media/npu/Data/nc/CityScapes/training_logs/model_eval_val/fix_50_lpA_ALL")
os.environ.setdefault("CITYSCAPES_DATASET", "/media/npu/Data/nc/CityScapes/leftImg8bit/meta")
...
# The main method
def main():
    # os.environ['CITYSCAPES_RESULTS'] = "/media/npu/Data/nc/CityScapes/training_logs/model_eval_val/original"
    # os.environ['CITYSCAPES_DATASET'] = "/media/npu/Data/nc/CityScapes/leftImg8bit/meta"
...
if __name__ == "__main__":
    os.environ.setdefault("CITYSCAPES_RESULTS", "/media/npu/Data/nc/CityScapes/training_logs/model_eval_val/original")
    os.environ.setdefault("CITYSCAPES_DATASET", "/media/npu/Data/nc/CityScapes/leftImg8bit/meta")
