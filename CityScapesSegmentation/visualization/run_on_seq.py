...
from CityScapes.datasets import DatasetSeq # (this needs to be imported before torch, because cv2 needs to be imported before torch for some reason)
...
network = DeepLabV3("eval_seq", project_dir="/media/npu/Data/nc/CityScapes")
network.load_state_dict(torch.load("/media/npu/Data/nc/CityScapes/training_logs/model_1/checkpoints/model_1_epoch_30.pth",
                                   map_location=torch.device("cpu")))

for sequence in ["00", "01", "02"]:
    print (sequence)

    val_dataset = DatasetSeq(cityscapes_data_path="/media/npu/Data/nc/CityScapes",
