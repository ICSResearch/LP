...
def load_checkpoint(model, checkpoint_path, use_ema=False, strict=True):
    ...
    # keys = ["blocks.0.mlp.fc1.weight", "blocks.0.mlp.fc2.weight", "blocks.1.mlp.fc1.weight", "blocks.1.mlp.fc2.weight", "blocks.2.mlp.fc1.weight", "blocks.2.mlp.fc2.weight", "blocks.3.mlp.fc1.weight", "blocks.3.mlp.fc2.weight", "blocks.4.mlp.fc1.weight", "blocks.4.mlp.fc2.weight", "blocks.5.mlp.fc1.weight", "blocks.5.mlp.fc2.weight", "blocks.6.mlp.fc1.weight", "blocks.6.mlp.fc2.weight", "blocks.7.mlp.fc1.weight", "blocks.7.mlp.fc2.weight", "blocks.8.mlp.fc1.weight", "blocks.8.mlp.fc2.weight", "blocks.9.mlp.fc1.weight", "blocks.9.mlp.fc2.weight", "blocks.10.mlp.fc1.weight", "blocks.10.mlp.fc2.weight", "blocks.11.mlp.fc1.weight", "blocks.11.mlp.fc2.weight"]
    # for k in keys:
    #     del state_dict[k]
