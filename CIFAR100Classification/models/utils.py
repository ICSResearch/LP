"""utils_cifar10.py - Helper functions for building the model and for loading model parameters.
...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'split_factor', 'is_user_crop_size', 'user_crop_size'])
...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, image_size=None, **kwargs):
        ...
        pad_h = max((oh - 1) * self.stride[0] + (kh - 1) * self.dilation[0] + 1 - ih, 0)
        pad_w = max((ow - 1) * self.stride[1] + (kw - 1) * self.dilation[1] + 1 - iw, 0)
        '''3d400a5 commit at 09/10/2020 in the original repo
        if pad_h > 0 or pad_w > 0:
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
    ...
    if split_factor == 1:
        ...
        blocks_args = [
            'r1_k3_s11_e1_i24_o12_se0.25',
            'r2_k3_s22_e6_i12_o16_se0.25',
            'r2_k5_s22_e6_i16_o24_se0.25',
            'r3_k3_s22_e6_i24_o56_se0.25',
            'r3_k5_s11_e6_i56_o80_se0.25',
            'r4_k5_s22_e6_i80_o136_se0.25',
            'r1_k3_s11_e6_i136_o224_se0.25',
        ]
    elif split_factor == 4:
        blocks_args = [
            'r1_k3_s11_e1_i16_o12_se0.25',
            'r2_k3_s22_e6_i12_o16_se0.25',
            'r2_k5_s22_e6_i16_o20_se0.25',
            'r3_k3_s22_e6_i20_o40_se0.25',
            'r3_k5_s11_e6_i40_o56_se0.25',
            'r4_k5_s22_e6_i56_o96_se0.25',
    ...
    # the dropout rate is divided by sqrt(split_factor)
    dropout_rate = dropout_rate / (split_factor ** 0.5)
    drop_connect_rate = drop_connect_rate / (split_factor ** 0.5)
    global_params = GlobalParams(
        ...
        depth_divisor=8 if split_factor == 1 else 4,
        min_depth=None,
...
def get_model_params(model_name, override_params):
    ...
    Returns:
        blocks_args, global_params
    """
    split_factor = override_params["split_factor"]
    is_user_crop_size = override_params["is_user_crop_size"]
    user_crop_size = override_params["user_crop_size"]
    if model_name.startswith('efficientnet'):
        w, d, s, p = efficientnet_params(model_name)

        # note: all models have drop connect rate = (0.2 / (sqrt(split_factor)))
        blocks_args, global_params = efficientnet(
            width_coefficient=w,
            depth_coefficient=d,
            dropout_rate=p,
            image_size=s if not is_user_crop_size else user_crop_size,
