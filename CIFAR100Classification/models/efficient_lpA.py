...
from learnning_padding import LearningPaddingA_AllStride, LearningPaddingC
...
class ConvBlock(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1,
        ...
        if padding == 1:
            layers.append(LearningPaddingA_AllStride(in_planes, padding))
            layers.append(nn.Conv2d(in_channels=in_planes, out_channels=out_planes,
