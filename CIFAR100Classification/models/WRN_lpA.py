...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return nn.Sequential(LearningPaddingA_AllStride(in_planes, dilation),
...
class ResNet(nn.Module):
    ...
    def __init__(self, arch, block, layers, num_classes=100, zero_init_residual=True,
                 ...
                 norm_layer=None, dataset='cifar100', split_factor=1, output_stride=8, dropout_p=None):
        ...
        # n_channels = [64, 128, 256, 512]
            ...
            self.layer0 = nn.Sequential(
                ...
                LearningPaddingA_AllStride(3),
                nn.Conv2d(3, self.inplanes, kernel_size=3, stride=1, padding=0, bias=False),
                norm_layer(self.inplanes),
                nn.ReLU(inplace=True),
            )
            inplanes_origin = self.inplanes
