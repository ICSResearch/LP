...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default='vgg16_lpC', help='net type')
    ...
    train_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[25, 50], gamma=0.1) #learning rate decay
    ...
    if args.resume:
        ...
        if best_weights:
            ...
            net.load_state_dict(torch.load(weights_path, map_location=torch.device('cuda:3')))
